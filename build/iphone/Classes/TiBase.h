...
// in simulator we redefine to format for myfoot Developer console
...
{\
	NSString * exceptionName = [@"org.myfoot." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.myfoot";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UImyfootNativeItemNone = -1, 
	UImyfootNativeItemSpinner = -2,
	UImyfootNativeItemProgressBar = -3,
	
	UImyfootNativeItemSlider = -4,
	UImyfootNativeItemSwitch = -5,
	UImyfootNativeItemMultiButton = -6,
	UImyfootNativeItemSegmented = -7,
	
	UImyfootNativeItemTextView = -8,
	UImyfootNativeItemTextField = -9,
	UImyfootNativeItemSearchBar = -10,
	
	UImyfootNativeItemPicker = -11,
	UImyfootNativeItemDatePicker = -12,
	
	UImyfootNativeItemInfoLight = -13,
	UImyfootNativeItemInfoDark = -14,
	
	UImyfootNativeItemDisclosure = -15,
	
	UImyfootNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all myfoot instances of
